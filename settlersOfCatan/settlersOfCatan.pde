...
void draw(){//lots of this code is in the repo I linked you
  if (State == 0){
    ...
    textSize(30);
    fill(0, 102, 153, 51);
    text("A digital project designed by:", 290, 160);
    text("Sebastian Iturregui-Shelton and Chang Ju Kim", 160, 200);
    text("Number of players:", 350, 400); 
    text("Two Players", 350, 450);
